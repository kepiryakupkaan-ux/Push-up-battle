...
object BadgeDefinitions {
    ...
    val ALL = listOf(
        ...
        Badge("league_silver", "Gümüşe Yükseliş", "🥈", "İlk kez Gümüş lige ulaştın"),
        Badge("league_gold", "Altına Yükseliş", "🥇", "İlk kez Altın lige ulaştın"),
        Badge("league_diamond", "Elmasa Yükseliş", "💎", "İlk kez Elmas lige ulaştın")
    )
