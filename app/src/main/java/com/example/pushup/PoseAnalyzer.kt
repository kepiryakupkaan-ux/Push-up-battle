...
class PoseAnalyzer(
     ...
     *
     * NOT (dürüst uyarı): Bu ortamda Android SDK/cihaz yok, bu yüzden gerçek bir telefonda
     * test edilemedi. Noktalar ters, kaymış ya da 90° dönük görünürse büyük ihtimalle
     * burada rotation case'lerinden biri (90/180/270) ya da son satırdaki mirror (1f - nx)
