...
class AuthClient {
    ...
    fun register(
        ...
        db.runTransaction { txn ->
            ...
            // DÜZELTME: hesap açılır açılmaz "players" dokümanı da Elo=0 ile oluşturuluyor,
            // böylece skor tablosunda ilk maçtan önce bile 0 Elo'dan görünür (puan sistemi
            // kaldırıldı, artık tek metrik Elo - bkz. LeaderboardClient).
            LeaderboardClient().initializePlayerDoc(id, username.trim(), photoBase64)
