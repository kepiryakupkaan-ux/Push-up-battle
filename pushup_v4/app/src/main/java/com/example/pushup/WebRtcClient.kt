...
class WebRtcClient(
    ...
    fun startLocalCapture(localRenderer: SurfaceViewRenderer, onFrontCameraMissing: () -> Unit = {}): VideoTrack? {
        ...
        // PIP alanı kamera output oranıyla aynı tutuluyor (360x480 = 3:4).
        // SCALE_ASPECT_FILL ile renderer ve PoseOverlay aynı dikey video alanını kullanıyor;
        // böylece skeleton, renderer'ın içinde ekstra crop/boşluk farkı yaşamıyor.
